            ...
            <div className="account-container">
                ...
                <div className="farm-info">
                    ...
                    <div className="farm-details">
                        <p><strong>Farm size:</strong> {farmData?.size || "N/A"}</p>
                        <p><strong>Area:</strong> {farmData?.area || "N/A"}</p>
                        <p><strong>Fields:</strong> {farmData?.fields || "N/A"}</p>
                        <p><strong>Address:</strong> {farmData?.address || "N/A"}</p>
                        <p><strong>Opened:</strong> {farmData?.opened || "N/A"}</p>
                    </div>
                </div>
            </div>
        </div>
